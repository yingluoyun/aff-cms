        ...
        <div class="layui-tab-content layui-form">
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        ...
                        <img src="{{$data->topimgurl=='parent'?'/static/images/parent.png':$data->topimgurl}}" alt="{{$data->topimgalt}}" id="topimgurl1" width="400">
                        <br>
            ...
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main1img1" name="main1img1" class="layui-input" value="{{$data->main1img1}}">
                        <img src="{{$data->main1img1=='parent'?'/static/images/parent.png':$data->main1img1}}" alt="{{$data->main1img1alt}}" id="main1img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main1img2" name="main1img2" class="layui-input" value="{{$data->main1img2}}">
                        <img src="{{$data->main1img2=='parent'?'/static/images/parent.png':$data->main1img2}}" alt="{{$data->main1img2alt}}" id="main1img21" width="100">
                        <br>
            ...
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main2img1" name="main2img1" class="layui-input" value="{{$data->main2img1}}">
                        <img src="{{$data->main2img1=='parent'?'/static/images/parent.png':$data->main2img1}}" alt="{{$data->main2img1alt}}" id="main2img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main2img2" name="main2img2" class="layui-input" value="{{$data->main2img2}}">
                        <img src="{{$data->main2img2=='parent'?'/static/images/parent.png':$data->main2img1}}" alt="{{$data->main2img2alt}}" id="main2img21" width="100">
                        <br>
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main3img1" name="main3img1" class="layui-input" value="{{$data->main3img1}}">
                        <img src="{{$data->main3img1=='parent'?'/static/images/parent.png':$data->main3img1}}" alt="{{$data->main3img1alt}}" id="main3img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main3img2" name="main3img2" class="layui-input" value="{{$data->main3img2}}">
                        <img src="{{$data->main3img2=='parent'?'/static/images/parent.png':$data->main3img2}}" alt="{{$data->main3img2alt}}" id="main3img21" width="100">
                        <br>
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main4img1" name="main4img1" class="layui-input" value="{{$data->main4img1}}">
                        <img src="{{$data->main4img1=='parent'?'/static/images/parent.png':$data->main4img1}}" alt="{{$data->main4img1alt}}" id="main4img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main4img2" name="main4img2" class="layui-input" value="{{$data->main4img2}}">
                        <img src="{{$data->main4img2=='parent'?'/static/images/parent.png':$data->main4img2}}" alt="{{$data->main4img2alt}}" id="main4img21" width="100">
                        <br>
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main5img1" name="main5img1" class="layui-input" value="{{$data->main5img1}}">
                        <img src="{{$data->main5img1=='parent'?'/static/images/parent.png':$data->main5img1}}" alt="{{$data->main5img1alt}}" id="main5img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="main5img2" name="main5img2" class="layui-input" value="{{$data->main5img2}}">
                        <img src="{{$data->main5img2=='parent'?'/static/images/parent.png':$data->main5img2}}" alt="{{$data->main5img2alt}}" id="main5img21" width="100">
                        <br>
            ...
            <div class="layui-form-item">
                    ...
                    <input type="text" id="banner1img" name="banner1img" class="layui-input" value="{{$data->banner1img}}">
                        <img src="{{$data->banner1img=='parent'?'/static/images/parent.png':$data->banner1img}}" alt="{{$data->banner1imgalt}}" id="banner1img1" width="400">
                        <br>
             ...
             <div class="layui-form-item">
                    ...
                    <input type="text" id="banner2img" name="banner2img" class="layui-input" value="{{$data->banner2img}}">
                        <img src="{{$data->banner2img=='parent'?'/static/images/parent.png':$data->banner2img}}" alt="{{$data->banner2imgalt}}" id="banner2img1" width="400">
                        <br>
