...
<body>
    ...
    <div class="layui-tab">
        ...
        <input type="hidden" id="theme" name="theme" class="layui-input" value="1" >
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    <label for="abbr" class="layui-form-label">主站简称</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="abbr" name="abbr" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="url" class="layui-form-label">主站地址</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="url" name="url" class="layui-input" value="www.test.com">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="title" class="layui-form-label">网站标题</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="title" name="title" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">网站描述</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <textarea name="description" class="layui-textarea">TEST</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="topimgurl" name="topimgurl" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="topimgurl1" width="400">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="topimgalt" name="topimgalt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="toptext1" class="layui-form-label">文本描述1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="toptext1" name="toptext1" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="toptext2" class="layui-form-label">文本描述2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="toptext2" name="toptext2" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="toptext3" class="layui-form-label">文本描述3</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="toptext3" name="toptext3" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="iosurl" class="layui-form-label">苹果下载url</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="iosurl" name="iosurl" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="andurl" class="layui-form-label">谷歌下载url</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="andurl" name="andurl" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="weburl" class="layui-form-label">注册地址</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="weburl" name="weburl" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="webname" class="layui-form-label">注册描述</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="webname" name="webname" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main1img1" name="main1img1" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main1img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main1img1alt" name="main1img1alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main1img2" class="layui-form-label">主体图标</label>
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main1img2" name="main1img2" class="layui-input" value="/static/images/no_image_available.png" >
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main1img21" width="100">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main1img2alt" name="main1img2alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main1text1" class="layui-form-label">文本描述1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main1text1" name="main1text1" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main1text2" class="layui-form-label">文本描述2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main1text2" name="main1text2" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main2img1" name="main2img1" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main2img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main2img1alt" name="main2img1alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="title" class="layui-form-label">主体图标</label>
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main2img2" name="main2img2" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main2img21" width="100">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main2img2alt" name="main2img2alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main2text1" class="layui-form-label">文本描述1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="main2text1" id="main2text1" name="main2text1" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main2text2" class="layui-form-label">文本描述2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main2text2" name="main2text2" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main3img1" name="main3img1" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main3img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main3img1alt" name="main3img1alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="title" class="layui-form-label">主体图标</label>
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main3img2" name="main3img2" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main3img21" width="100">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main3img2alt" name="main3img2alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main3text1" class="layui-form-label">文本描述1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main3text1" name="main3text1" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main3text2" class="layui-form-label">文本描述2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main3text2" name="main3text2" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main4img1" name="main4img1" class="layui-input" value="/static/images/no_image_available.png" >
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main4img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main4img1alt" name="main4img1alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="title" class="layui-form-label">主体图标</label>
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main4img2" name="main4img2" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main4img21" width="100">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main4img2alt" name="main4img2alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main4text1" class="layui-form-label">文本描述1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main4text1" name="main4text1" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main4text2" class="layui-form-label">文本描述2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main4text2" name="main4text2" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main5img1" name="main5img1" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main5img11" width="200">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main5img1alt" name="main5img1alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="title" class="layui-form-label">主体图标</label>
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="main5img2" name="main5img2" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="main5img21" width="100">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main5img2alt" name="main5img2alt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main5text1" class="layui-form-label">文本描述1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main5text1" name="main5text1" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="main5text2" class="layui-form-label">文本描述2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="main5text2" name="main5text2" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
            <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="bannertitle" name="bannertitle" class="layui-input" value="TEST">
                    </div>
                </div>
            <div class="layui-form-item">
                    <label for="title" class="layui-form-label">幻灯片1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="banner1img" name="banner1img" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="banner1img1" width="400">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="banner1imgalt" name="banner1imgalt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="banner1title" class="layui-form-label">名称1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="banner1title" name="banner1title" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="banner1content" class="layui-form-label">文本1</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="banner1content" name="banner1content" class="layui-input" value="TEST">
                    </div>
                </div>
             ...
             <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" id="banner2img" name="banner2img" class="layui-input" value="/static/images/no_image_available.png">
                        <img src="/static/images/no_image_available.png" alt="TEST" id="banner2img1" width="400">
                        <br>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="banner2imgalt" name="banner2imgalt" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="banner2title" class="layui-form-label">名称2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="banner2title" name="banner2title" class="layui-input" value="TEST">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="banner2content" class="layui-form-label">文本2</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="banner2content" name="banner2content" class="layui-input" value="TEST">
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
            <label for="afooter" class="layui-form-label">底部内容</label>
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" id="afooter" name="afooter" class="layui-input" value="TEST">
                    </div>
            </div>
    ...
    <script>
        layui.use(['layer', 'form', 'upload', 'element'], function() {
            ...
            $('.submit1').on('click', function() {
			    ...
			    return layer.alert('所有字段均不能为空！',{icon:2});}
                if(theme==''){
			    return layer.alert('主题ID不能为空！',{icon:2});}
                if(abbr==''){
