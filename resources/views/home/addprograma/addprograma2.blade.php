...
<body>
    <div class="layui-form" style="padding: 10px;">
        @csrf
        <input type="hidden" class="layui-input" name="type" id="type" value="2">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 500px;">
                <input type="text" class="layui-input" name="title" id="title" value="" placeholder="请填写网页title">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" for="description">description</label>
            <div class="layui-input-inline" style="width: 500px;">
                <textarea class="layui-textarea" name="description" id="description" placeholder="请填写网页description"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" for="description"></label>
            <div class="layui-input-inline" style="width:100%">
                <script id="container" name="content" type="text/plain" style="width: 100%;height:500px">网页内容</script>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="lid" class="layui-form-label">排序</label>
            <div class="layui-input-inline" style="width:100px">
                <input type="number" class="layui-input" id="lid" name="lid">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script type="text/javascript">
        ...
        layui.use('form', function() {
            ...
            $('.add').on('click', function() {
                ...
                $.post('/addtoprograma2', data, function(res) {
                    if (res.code > 0) {
