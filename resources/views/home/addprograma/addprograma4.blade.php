...
<body>
    <div class="layui-form" style="padding: 10px;">
        @csrf
        <input type="hidden" class="layui-input" name="type" id="type" value="4">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 500px;">
                <input type="text" class="layui-input layui-disabled" name="url" id="url" value="/site.html" disabled>
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script type="text/javascript">
        layui.use('form', function() {
            ...
            $('.add').on('click', function() {
                ...
                $.post('/addtoprograma4', data, function(res) {
                    if (res.code > 0) {
